const CACHE_NAME = 'reeky-foundry-shell-v6';
const LEGACY_SHELL_CACHE_NAMES = ['reeky-foundry-shell-v5', 'reeky-foundry-shell-v4', 'reeky-foundry-shell-v3', 'reeky-foundry-shell-v2', 'reeky-foundry-shell-v1'];
...
const APP_SHELL = ['/', '/index.html', '/reeky-foundry-mark.svg', '/reeky-foundry-mark.png', '/favicon.svg', '/apple-touch-icon.png', '/manifest.webmanifest'];
